...
const config = Object.freeze({
  ...
  APP_MAX_GROUPS: Number(env.APP_MAX_GROUPS) || 10,
  APP_MAX_USERS: Number(env.APP_MAX_USERS) || 50,
  ...
  BOT_INIT_PROMPT: env.BOT_INIT_PROMPT || '現在我將模擬一位成熟的管家，我會很熱情地做出反應。如果我不能理解的話，我會說「這個我不是很清楚呢。」',
